...
export default function Nav() {
  ...
  return (
    <>
         <header className="bg-judbr-main text-xm">
      <nav className="bg-judbr-main fixed top-0 w-full z-50">
        <div className="md:px-8 lg:px-16 xl:px-24 flex flex-col md:flex-row items-center justify-between max-w-screen-xl mx-auto scale-100 xl:scale-80 xl:origin-top-center p-4">
          {/* Logo */}
          <div className="hidden md:block">
            <Link href="/" className="text-white font-bold text-xl">
              <img src="/image/judbr-white.png" alt="JUDBR Logo" width={130} height={120} />
            </Link>
          </div>
            {/* Logo (não modificada) */}
            ...
            <Link href="/pages/precos" className="text-white hover:text-gray-200">Preços</Link>
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-5 w-[650px] bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
