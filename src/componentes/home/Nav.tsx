        ...
        <nav className="bg-blue-700 py-4">
          <div className="container mx-auto px-9 md:px-30 lg:px-40 xl:px-48 flex justify-between items-center">
            <div className="flex items-center">
              <Link href="/" className="text-white font-bold text-xl">
                <Image src="/image/judbr-white.png" alt="JUDBR Logo" width={80} height={80} />
              </Link>
            </div>
            
            {/* Menu para desktop */}
            <div className="hidden md:flex items-center space-x-6">
              <Link href="/pages/precos/" className="text-white hover:text-gray-200 transition-colors">Preços</Link>
          ...
          <div className={`md:hidden ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link href="/pages/recursos" className="block text-white hover:text-gray-100 py-2">Recursos</Link>
              <Link href="/pages/sobre-nos" className="block text-white hover:text-gray-100 py-2">Sobre Nós</Link>
              <Link href="/pages/contato" className="block text-white hover:text-gray-100 py-2">Contato</Link>
              <Link href="#" onClick={openEmailModal} className="block bg-[#24B364] text-white px-4 py-2 rounded-full hover:bg-[#008c3f] mt-4 transition duration-300">
                Experimente Grátis
              </Link>
            </div>
          </div>
