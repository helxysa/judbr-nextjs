...
const HomePage = () => {
    ...
    <div className="md:w-1/2 text-center md:text-right mt-10 md:mt-0">
      <div className="text-4xl md:text-5xl lg:text-4xl font-bold text-gray-900 p-4 rounded-lg inline-block">
        <video 
          ...
          muted 
          playsInline
          className="max-w-full h-auto md:max-w-[90%] lg:max-w-[90%] mx-auto rounded-lg"
        >
  ...
  <div className="container mx-auto px-9 md:px-30 lg:px-40 xl:px-48 space-y-16 py-16">
          <Section />
        </div>

        <div className="bg-gray-100 w-full">
          <div className="container mx-auto px-9 md:px-30 lg:px-40 xl:px-48 py-16">
            <LegalPracticeStats />
          </div>
        </div>
