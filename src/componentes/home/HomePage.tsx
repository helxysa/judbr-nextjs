  ...
  return (
     <div className="flex flex-col min-h-screen">
      <main className="flex-grow">
        ...
        <div 
            className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-24 flex flex-col md:flex-row items-center justify-between max-w-screen-xl mx-auto scale-100 xl:scale-80 xl:origin-top-center"
          >
            <div className="md:w-1/2 mb-5 md:mb-0 md:pr-4 lg:pr-8 xl:1380:pr-16 xl:1380:ml-16">
              <h1 className="text-3xl md:text-3xl tracking-wide lg:text-[40px] font-bold text-judbr-gray mb-5 xl:1380:text-4xl">
                Simplifique a Gestão <br/> do Seu Escritório de Advocacia
              </h1>
              <p className="text-base md:text-lg tracking-wider lg:text-xm text-judbr-gray mb-8 xl:1380:text-1xl">Gerencie clientes, documentos e processos jurídicos <br/>em uma plataforma intuitiva e segura.</p>
              <form className="flex flex-col sm:flex-row" onSubmit={(e) => e.preventDefault()}>
                ...
                <button 
                  type="submit" 
                  className="bg-green-500 text-white tracking-widest font-semibold tracking-wide px-5 py-2 rounded-full hover:bg-green-600 transition duration-300 w-full sm:w-auto text-sm"
                >
                  INICIAR TESTE GRÁTIS
                </button>
              </form>

              <div className="flex flex-wrap items-center text-sm text-judbr-gray mt-4">
                <div className="flex items-center mr-6 mb-2">
                  ...
                  <span className='tracking-widest'>7 dias de teste grátis</span>
                </div>
                ...
                <div className="flex items-center mb-2">
                  ...
                  <span className='tracking-widest'>Sem necessidade de cartão de crédito</span>
                </div>
              </div>
            </div>
            <div className="md:w-1/2 text-center md:text-right mt-10 md:mt-0">
              <div className="inline-block">
                <video 
                  ...
                  muted 
                  playsInline
                  className="w-full h-auto md:max-w-[150%] lg:max-w-[160%] xl:1380:max-w-[100%] mx-auto rounded-lg"
                >
