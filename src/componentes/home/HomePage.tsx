...
export default function HomePage (){
  ...
  <div className="container mx-auto  px-4 md:px-8 lg:px-16 xl:px-24 flex flex-col md:flex-row items-center justify-between">
    <div className="md:w-1/2 mb-5 md:mb-0 md:pr-4 lg:pr-8">
      <h1 className="text-4xl md:text-4xl tracking-wide lg:text-5xl font-bold text-judbr-gray mb-5">
        Simplifique a Gestão <br/> do  Seu Escritório de Advocacia
      </h1>
      <p className="text-base md:text-lg tracking-wider lg:text-xl text-judbr-gray mb-8">Gerencie clientes, documentos e processos jurídicos <br/>em uma plataforma intuitiva e segura.</p>
