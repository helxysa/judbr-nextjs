...
export default function ChatBot() {
    ...
    return (
        <div className="fixed bottom-4 right-4">
            <div className={`absolute bottom-0 right-0 transition-all duration-300 ease-in-out ${isOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
            ...
            <button
                ...
                className={`bg-judbr-main text-white p-4 rounded-full shadow-lg hover:bg-purple-600 transition-all duration-300 ease-in-out ${isOpen ? 'opacity-0 scale-95 pointer-events-none' : 'opacity-100 scale-100'}`}
            >
