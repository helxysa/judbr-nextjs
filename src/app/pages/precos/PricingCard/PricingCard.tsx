  ...
  return (
    <div className="relative h-full group">
      ...
      <div className={`
        ...
        ${isPopular ? 'border-t-8 border-judbr-main ring-2 ring-judbr-main' : 'border-t-8 border-gray-800'}
      ...
      `}>
        ...
        <Link 
          href="#" 
          className={`text-white text-center px-6 py-3 rounded-full transition duration-300 text-sm font-semibold whitespace-nowrap overflow-hidden text-ellipsis ${isPopular ? 'bg-judbr-main hover:bg-opacity-90' : 'bg-gray-800 hover:bg-gray-900'}`}
        >
